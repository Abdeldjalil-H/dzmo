    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topics', django.contrib.postgres.fields.ArrayField(base_field=lessons.models.TopicField(choices=[('a', 'جبر'), ('g', 'هندسة'), ('nt', 'نظرية الأعداد'), ('c', 'توفيقات'), ('b', 'أساسيات')], max_length=2), blank=True, default=accounts.models.default_topics, null=True, size=None)),
