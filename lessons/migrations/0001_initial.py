    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.CharField(choices=[('a', 'جبر'), ('g', 'هندسة'), ('nt', 'نظرية الأعداد'), ('c', 'توفيقات'), ('b', 'أساسيات')], max_length=20, verbose_name='المادة')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('one', 'إختيار إجابة واحدة'), ('multiple', 'إختيار إجابات'), ('result', 'الإجابة بعدد')], max_length=30, verbose_name='نوع التمرين')),
                ...
                ('points', models.IntegerField(choices=[(3, '3'), (6, '6'), (9, '9'), (12, '12')], default=3)),
                ('chapter', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lessons.chapter', verbose_name='المحور')),
            ],
            options={
                'verbose_name': 'تمرين',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lessons.exercice')),
        ...
        migrations.AddField(
            model_name='chapter',
            name='prereq',
            field=models.ManyToManyField(blank=True, to='lessons.PrereqChapter', verbose_name='المكتسبات اللازمة'),
        ),
    ]
